...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //Error handling set
    if (empty_reg_fields($u_id, $f_name, $l_name, $e_mail, $u_password, $rep_password) !== false) {
    ...
    if (existing_user_n_email($conn, $u_id, $e_mail) !== false) {
    ...
    if (unmatching_passwords($u_password, $rep_password) !==false) {
        ...
        register_user($conn, $u_id, $f_name, $l_name, $e_mail, $u_password);
