...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var number_items = document.querySelectorAll("#spanish-numbers .list_item");
    ...
    task_item.forEach(function(task) {
        ...
        task.addEventListener("drop", function(event) {
            ...
            if (!task.querySelector(".number")) {
                ...
                span.textContent = dragged_number.textContent;
                task.appendChild(span);

                //Add steps to user's order
                user_order.push(parseInt(number));
